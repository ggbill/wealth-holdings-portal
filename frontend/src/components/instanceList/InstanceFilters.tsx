...
const InstanceFilters = (props: InputProps) => {
    ...
    const [tableFilters, setTableFilters] = useState<any>({ currentActivity: "All", assignedBdm: "All", ragStatus: "All" })
    ...
    const filterActiveCases = (): void => {
        ...
        filteredActiveCases = filteredActiveCases.filter(activeCase => {
            return (
                (tableFilters.currentActivity === "All" || activeCase._current_step === tableFilters.currentActivity) &&
                (tableFilters.ragStatus === "All" || commonFunctions.determineRAGStatus(activeCase) === tableFilters.ragStatus) &&
                (tableFilters.assignedBdm === "All" || activeCase.assignedBdm.Name === tableFilters.assignedBdm)
            )
        });
        ...
        <div className="filters">
            ...
            <FormControl className="current-activity">
                ...
                <Select
                    ...
                    value={tableFilters.currentActivity}
            ...
            <FormControl className="assigned-bdm">
                ...
                <Select
                    ...
                    name="assignedBdm"
                    value={tableFilters.assignedBdm}
                    onChange={handleChange}
                >
                    <MenuItem value="All">All</MenuItem>
                    {
