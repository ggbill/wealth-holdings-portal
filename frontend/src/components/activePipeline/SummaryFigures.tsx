...
const SummaryFigures = (props: InputProps) => {
    ...
    const populateSummaryFigures = (): void => {
        let tempSummaryFigures = [
            ...
            { name: "Wealth Holdings Fees", value: 0, isCurrency: true, isDisplay: isDisplay },
            { name: "SimplyBiz Fees", value: 0, isCurrency: true, isDisplay: isDisplay },
            { name: "Introducer Fees", value: 0, isCurrency: true, isDisplay: isDisplay },
